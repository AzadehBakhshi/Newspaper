 ...
 * @author Azadeh
 */
public class EditJournalist extends javax.swing.JFrame {

    private final Journalist currentJournalist;
     ...
     * @param RecId
     */
    public EditJournalist(AdminMain main, int RecId) {

        initComponents();

        this.main = main;

        this.journalist = new dbJournalist();
        currentJournalist = this.journalist.Find(RecId);

        txtFirstname.setText(currentJournalist.getFirstName());
        txtLastname.setText(currentJournalist.getLastName());
        txtEmail.setText(currentJournalist.getEmail());
        txtUsername.setText(currentJournalist.getUsername());
        txtPassword.setText(currentJournalist.getPassword());
        txtSalary.setText(String.valueOf(currentJournalist.getSalary()));
        txtExperience.setText(String.valueOf(currentJournalist.getPriorExperience()));

        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        txtRecruitment.setText(df.format(currentJournalist.getRecruitmentDate()));
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Edit Journalist...");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        newJournalist.setId(currentJournalist.getId());
        newJournalist.setFirstName(txtFirstname.getText());
        newJournalist.setLastName(txtLastname.getText());
        newJournalist.setEmail(txtEmail.getText());
        newJournalist.setUsername(txtUsername.getText());
        newJournalist.setPassword(txtPassword.getText());
        newJournalist.setPriorExperience(PriorExperience);
        newJournalist.setRecruitmentDate(RecruitmentDate);
        newJournalist.setSalary(Salary);

        journalist.Update(newJournalist);
