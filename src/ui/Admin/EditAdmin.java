...
public class EditAdmin extends javax.swing.JFrame {
     ...
     * @param RecId
     */
    public EditAdmin(AdminMain main, int RecId) {

        initComponents();

        this.main = main;

        this.admin = new dbAdmin();
        currentAdmin = this.admin.Find(RecId);

        txtFirstname.setText(currentAdmin.getFirstName());
        txtLastname.setText(currentAdmin.getLastName());
        txtEmail.setText(currentAdmin.getEmail());
        txtUsername.setText(currentAdmin.getUsername());
        txtPassword.setText(currentAdmin.getPassword());
        txtSalary.setText(String.valueOf(currentAdmin.getSalary()));
        txtExperience.setText(String.valueOf(currentAdmin.getPriorExperience()));

        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        txtRecruitment.setText(df.format(currentAdmin.getRecruitmentDate()));
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        newAdmin.setId(currentAdmin.getId());
