 ...
 * @author Azadeh
 */
public class EditEditor extends javax.swing.JFrame {
     ...
     * @param RecId
     */
    public EditEditor(AdminMain main, int RecId) {

        initComponents();

        this.main = main;

        this.editor = new dbEditor();
        currentEditor = this.editor.Find(RecId);

        txtFirstname.setText(currentEditor.getFirstName());
        txtLastname.setText(currentEditor.getLastName());
        txtEmail.setText(currentEditor.getEmail());
        txtUsername.setText(currentEditor.getUsername());
        txtPassword.setText(currentEditor.getPassword());
        txtSalary.setText(String.valueOf(currentEditor.getSalary()));
        txtExperience.setText(String.valueOf(currentEditor.getPriorExperience()));

        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        txtRecruitment.setText(df.format(currentEditor.getRecruitmentDate()));
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Edit Editor Chief...");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        newEditor.setId(currentEditor.getId());
